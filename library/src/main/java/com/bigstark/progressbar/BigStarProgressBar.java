...
public class BigStarProgressBar extends View {
    ...
    public static final float RADIUS_DEFAULT = 100f;

    public static final int COLOR_PATH_DEFAULT = 0xAAAAAA;
    public static final int COLOR_PROGRESS_DEFAULT = 0x5A3296;

    private Path backgroundPath;
    private Path barPath;
    private Paint paint;

    private int pathColor = COLOR_PATH_DEFAULT;
    private int progressColor = COLOR_PROGRESS_DEFAULT;
    ...
    public void start() {
        if (animator == null) {
            animator = ObjectAnimator.ofFloat(this, "scale", 1f);
    ...
    public void setPathColorResource(int pathColorResource) {
        int pathColor = getResources().getColor(pathColorResource);
    ...
    public void setProgressColorResource(int progressColorResource) {
        int progressColor = getResources().getColor(progressColorResource);
